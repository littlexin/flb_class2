...
void pwm_set_duty_ratio(int channel, int ratio)
{
    ...
    switch (channel)	
    {
        case 1: TIM_SetCompare1(TIM3, ratio);break;
        case 2: TIM_SetCompare2(TIM3, ratio);break;
        case 3: TIM_SetCompare3(TIM3, ratio);break;
        case 4: TIM_SetCompare4(TIM3, ratio);break;
        default:
            break;
    }
}
